  ...
  return (
    ...
    >
      <motion.div 
        ...
        animate={{ y: 0, scale: 1 }}
        className="bg-white dark:bg-slate-900 border-2 border-teal-500/40 dark:border-teal-400/50 shadow-[0_0_24px_rgba(20,184,166,0.3)] rounded-3xl w-full max-w-md overflow-hidden relative"
      >
         ...
         <div className="p-8 pb-6">
            <div className="w-14 h-14 bg-teal-50 dark:bg-teal-900/30 rounded-2xl flex items-center justify-center mb-6 border border-teal-100 dark:border-teal-500/20 shadow-[0_0_12px_rgba(20,184,166,0.25)]">
              <QrCode className="w-7 h-7 text-teal-600 dark:text-teal-400 animate-pulse" />
            </div>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[9px] bg-teal-500/15 border border-teal-500/30 text-teal-600 dark:text-teal-400 font-extrabold uppercase px-2.5 py-0.5 rounded-full tracking-widest animate-pulse">
                Acceso Clínico Seguro
              </span>
            </div>
            <h2 className="text-2xl font-display font-black text-slate-800 dark:text-white mb-2 tracking-tight">Paciente</h2>
